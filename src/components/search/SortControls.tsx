    ...
    <div className="flex items-center gap-4">
      <div className="flex items-center gap-2">
        ...
        <Select value={sortConfig.field} onValueChange={handleFieldChange}>
          <SelectTrigger className="w-48 focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0 shadow-none">
        ...
        <Button
          ...
          className="h-10 w-10 p-0 focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0 shadow-none"
