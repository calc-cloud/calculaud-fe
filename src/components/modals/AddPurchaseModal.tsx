    ...
    if (field === 'currency' && index === 0 && costs.length > 1) {
      ...
      if (newFirstCurrency === Currency.SUPPORT_USD) {
        ...
        if (currentSecondCurrency !== Currency.AVAILABLE_USD) {
          updatedCosts[1] = { ...updatedCosts[1], currency: Currency.AVAILABLE_USD };
        }
        ...
        if (currentSecondCurrency !== Currency.SUPPORT_USD) {
          updatedCosts[1] = { ...updatedCosts[1], currency: Currency.SUPPORT_USD };
        }
      }
    }
          ...
          <div className="space-y-4">
            ...
            <div className="text-sm text-gray-600 bg-blue-50 p-3 rounded-lg">
              ...
              <ul className="text-xs space-y-1">
                <li>• <strong>ILS:</strong> Only one cost allowed</li>
                <li>• <strong>USD:</strong> You can add both USD Support and USD Available (max 2 costs)</li>
